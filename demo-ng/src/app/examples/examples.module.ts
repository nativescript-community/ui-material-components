...
@NgModule({
    imports: [ExamplesRoutingModule, ButtonsModule, CardsModule, BottomSheetModule, RippleModule, TextFieldModule, SliderModule, ProgressModule, ActivityIndicatorModule]
})
