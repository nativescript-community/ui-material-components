...
@Component({
    selector: 'home',
    template: `<StackLayout horizontalAlignment="center">
		...
		<MaterialButton text="flat button" rippleColor="blue" backgroundColor="yellow" variant="flat" (tap)="onTap('mbutton3', $event)"></MaterialButton>
