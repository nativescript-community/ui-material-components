...
export class Button extends ButtonBase {
    ...
    _ios: MDCButton
    applyShapeScheme() {
        MDCButtonShapeThemer.applyShapeSchemeToButton(
            this.shapeScheme,
    ...
    public createNativeView() {
        ...
        if (this.variant === "text") {
            ...
            if (colorScheme) {
                MDCTextButtonColorThemer.applySemanticColorSchemeToButton(
                    colorScheme,
                    view
                )
            }
            ...
            if (colorScheme) {
                MDCButtonColorThemer.applySemanticColorSchemeToButton(
                    colorScheme,
                    view
                )
            }
            ...
            if (colorScheme) {
                MDCOutlinedButtonColorThemer.applySemanticColorSchemeToButton(
                    colorScheme,
                    view
                )
            }
        } else {
            MDCContainedButtonThemer.applySchemeToButton(
                getButtonScheme(),
                view
            )
            if (colorScheme) {
                MDCContainedButtonColorThemer.applySemanticColorSchemeToButton(
                    colorScheme,
                    view
                )
            }
    ...
    [elevationProperty.setNative](value: number) {
        this.nativeViewProtected.setElevationForState(
            value,
    ...
    private setBottomLeftCornerRadius(value: number) {
        ...
        shapeScheme.smallComponentShape.bottomLeftCorner = MDCCornerTreatment.cornerWithRadius(
            value
        )
    ...
    private setBottomRightCornerRadius(value: number) {
        const shapeScheme = this.getShapeScheme()
        shapeScheme.smallComponentShape.bottomRightCorner = MDCCornerTreatment.cornerWithRadius(
            value
        )
        // MDCButtonShapeThemer.applyShapeSchemeToButton(this.shapeScheme, this._ios);
    }
    private setTopLeftCornerRadius(value: number) {
        const shapeScheme = this.getShapeScheme()
        shapeScheme.smallComponentShape.topLeftCorner = MDCCornerTreatment.cornerWithRadius(
            value
        )
        // MDCButtonShapeThemer.applyShapeSchemeToButton(this.shapeScheme, this._ios);
    }
    private setTopRightCornerRadius(value: number) {
        const shapeScheme = this.getShapeScheme()
        shapeScheme.smallComponentShape.topRightCorner = MDCCornerTreatment.cornerWithRadius(
            value
        )
        // MDCButtonShapeThemer.applyShapeSchemeToButton(this.shapeScheme, this._ios);
    }
    ...
    [fontInternalProperty.setNative](value: Font | UIFont) {
        if (!(value instanceof Font) || !this.formattedText) {
            ...
            const font =
                value instanceof Font ? value.getUIFont(nativeView.font) : value
