import {
    ...
    thumbHollowAtStartProperty
} from "./slider-common"
import { themer } from "./material"
import { Color } from "tns-core-modules/color/color"
import { rippleColorProperty, elevationProperty, trackBackgroundColorProperty } from "./cssproperties"
...
export class Slider extends SliderBase {
    ...
    [thumbColorProperty.setNative](color: Color) {
        this.nativeViewProtected.setThumbColorForState(
            color ? color.ios : null,
            UIControlState.Normal
        )
    }
    [trackBackgroundColorProperty.setNative](color: Color) {
        this.nativeViewProtected.setTrackBackgroundColorForState(
            color ? color.ios : null,
            UIControlState.Normal
        )
    }
    [trackFillColorProperty.setNative](color: Color) {
        this.nativeViewProtected.setTrackFillColorForState(
            color ? color.ios : null,
            UIControlState.Normal
        )
    }
